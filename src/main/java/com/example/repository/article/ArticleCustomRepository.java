...
public class ArticleCustomRepository {
    ...
    public PageImpl<ArticleEntity> filter(ArticleFilterDTO filterDTO, int page, int size) {
        ...
        StringBuilder selectBuilder = new StringBuilder("Select new ArticleEntity(s.id,s.title,s.description,s.imageId,s.publishedDate) From ArticleEntity as s where visible = true ");
